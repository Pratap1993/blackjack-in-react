...
const App: React.FC = () => {
  ...
  return (
    <>
      <Nav bet={bet} message={message} balance={balance} /> 
      <Hand title={`Dealer's Point (${dealerScore})`} cards={dealerCards} />
      <Hand title={`Player's Point (${userScore})`} cards={userCards} />
      <Controls
        balance={balance}
        gameState={gameState}
